    ...
    public class PersonsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Persons != null ? 
                          ...
                          Problem("Entity set 'ModelContext.Persons'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Personid,Firstname,Lastname,Gender,Email,Phone")] Person person)
        {
